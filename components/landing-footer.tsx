...
type AppUrls = {
  ...
  projectExecutions: string
  vendorEngagements: string
}

export function LandingFooter({ appUrls }: { appUrls: AppUrls }) {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href={appUrls.vendors} className="text-sm hover:text-[#DDA15E] transition-colors">
                  Vendor Management
                </a>
              </li>
              <li>
                <a href={appUrls.reductionOpportunities} className="text-sm hover:text-[#DDA15E] transition-colors">
                  Reduction Opportunities
                </a>
              </li>
              <li>
                <a href={appUrls.projectExecutions} className="text-sm hover:text-[#DDA15E] transition-colors">
                  Project Executions
                </a>
              </li>
              <li>
                <a href={appUrls.vendorEngagements} className="text-sm hover:text-[#DDA15E] transition-colors">
                  Vendor Engagements
                </a>
              </li>
            </ul>

...
import { Users, Settings, Shield, Activity, Menu, Home, Lightbulb, ClipboardList, MessageSquare } from "lucide-react"
    ...
    <div className="flex flex-col min-h-[calc(100dvh-68px)] max-w-7xl mx-auto w-full">
      ...
      <div className="lg:hidden flex items-center justify-between bg-white border-b border-gray-200 p-4">
        <div className="flex items-center">
          <span className="font-medium">{isSettingsPage ? "Settings" : "Dashboard"}</span>
        </div>
      ...
      <div className="flex flex-1 overflow-hidden h-full">
        {/* Sidebar */}
        <aside
          className={`w-64 bg-white lg:bg-[#FEFAE0] border-r border-gray-200 lg:block ${
              ...
              <Link key={item.href} href={item.href} passHref>
                <Button
                  ...
                  className={`shadow-none my-1 w-full justify-start ${
                    pathname === item.href ? "bg-[#606C38] text-white" : "text-gray-700 hover:bg-[#606C38]/10"
                  }`}
